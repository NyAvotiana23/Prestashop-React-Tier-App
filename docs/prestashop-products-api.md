...
### You can define multiple specific prices in the same request, which is useful if you need prices with and without taxes:
- /api/products/2?price[my_price_tax_incl][use_tax]=1&price[my_price_tax_excl][use_tax]=0

Or if you want the product price along with its reduction detail: 
- /api/products/2?price[my_price][use_reduction]=1&price[my_reduction][only_reduction]=1